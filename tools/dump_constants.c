...
main(void)
{
    ...
    DUMP(UFFD_FEATURE_MISSING_HUGETLBFS);
#endif
#ifdef UFFD_FEATURE_MISSING_SHMEM
    DUMP(UFFD_FEATURE_MISSING_SHMEM);
#endif
    ...
    DUMP(UFFD_FEATURE_MINOR_HUGETLBFS);
#endif
#ifdef UFFD_FEATURE_MINOR_SHMEM
    DUMP(UFFD_FEATURE_MINOR_SHMEM);
#endif
#ifdef UFFD_FEATURE_EXACT_ADDRESS
    DUMP(UFFD_FEATURE_EXACT_ADDRESS);
#endif
